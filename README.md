...
Proyecto universitario de Computación Gráfica y Visual con C++, OpenGL clásico, FreeGLUT, Visual Studio 2026 Community, MSVC 14.51, VC v180 y Windows x64.
...
## Compilación en Visual Studio 2026
...
3. Abrir `ComputacionGraficaT3.sln` en Visual Studio 2026 Community.
4. Seleccionar `Debug | x64` o `Release | x64`.
5. Compilar el proyecto del ejercicio que se desea ejecutar.

Cada proyecto usa `PlatformToolset` `v180` para Visual Studio 2026 / MSVC 14.51, enlaza `freeglut.lib`, `opengl32.lib` y `glu32.lib`, e incluye rutas compatibles con `$(VcpkgRoot)installed\$(VcpkgTriplet)`. No se importa ningún archivo `.props` común adicional, evitando el error MSB4011 por importación duplicada.
